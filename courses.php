    ...
    <section id="hero">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-2"><a class="btn btn-primary" role="button" href="addcourses.php" style="color: #fed136;background: #002654;margin: 5px;">Add a Course</a></div>
            </div>
            <div class="row">
                <div class="col">
                    <h1 style="margin-bottom: 20px;"><br>Details of Registered Courses</h1>
                    <?php

                        // ... (session check and other code)
                        session_start();
                        ...
                        // Include course display function
                        require_once("displaycourses.php");
