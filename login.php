...
// Login query to fetch user record
                ...
                <div class="container">
                    <div class="row mb-5">
                        <div class="col-md-8 col-xl-6 text-center mx-auto">
                            <h2>Log in</h2>
                            <p class="w-lg-50">Welcome to login to my&nbsp;website. you need to be logged in to access some content on my website. If you are not yet registered, consider doing so.</p>
                        </div>
                    </div>
                        ...
                        <div class="col-md-6 col-xl-4">
                            <div class="card mb-5">
                                <div class="card-body d-flex flex-column align-items-center">
                                    <div class="bs-icon-xl bs-icon-circle bs-icon-primary bs-icon my-4" style="background: #002654;"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-person" style="color: #fed136;">
                                    ...
                                    <form class="text-center" method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
                                        ...
                                        <div class="mb-3"><input class="btn btn-primary d-block w-100" type="submit" style="background: #002654;color: #fed136;" name="submit" value="Login"></div>
                                        <p class="text-muted">Don't have an account?</p>
                                        <p style="margin-top: -13px;"><a href="register.php">Register</a></p>
                                    </form>
                                </div>
                            </div>
                        </div>
